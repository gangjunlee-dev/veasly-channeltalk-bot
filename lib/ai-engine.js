...
async function generateAnswer(userMessage, language, chatId, chatHistory) {
  ...
  try {
    ...
    // [2026-06-29] 운임/배송비 질문이면 최신 운임표를 권위 컨텍스트로 주입(하드코딩·stale 인용 차단) + stale 자동 감지
    var shippingCtx = '';
    try {
