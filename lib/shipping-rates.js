...
// [2026-08-18] '公斤'·'重量'·'材積' 추가 — 「請問一公斤多少錢？」처럼 '運費'가 안 들어간 요금 질문이
//   라이브 운임표 주입을 못 받아, AI가 프롬프트의 옛 고정금액을 인용하던 경로를 막는다.
var FEE_KEYWORDS = ['運費', '運送費', '配送費', '國際運費', '運費多少', '運費怎麼', '多少運費', '運費表', '寄到台灣', '寄台灣', '寄回台灣', '到台灣多少', '幾公斤', '公斤', '多重', '重量', '材積', 'shipping fee', 'shipping cost', 'freight', 'how much to ship', '배송비', '운임', '운송비', '送料', '運賃'];
