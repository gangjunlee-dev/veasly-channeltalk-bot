...
async function analyzeRecentChats(days) {
  ...
  try {
    ...
    var synonymGroups = {
      ...
      '到貨時間(배송기간)': ['到貨', '幾天', '多久', '來得及', '期了', '什麼時候到', '什麼時候寄', '預計到貨', '到貨時間', '快到了嗎', '還要多久', '是還沒到嗎', '還沒到', '沒到', '還沒收到'],
      '處理進度(처리현황)': ['處理中', '處理進度', '幫忙確認', '可以幫忙', '確認一下', '麻煩你們確認', '麻煩你們確認一下', '麻煩確認', '想詢問', '我想詢問一下', '請問一下'],
            '收費問題(요금문제)': ['被收了', '但我被收了', '多收', '收費', '扣款', '金額不對', '拔卡', '他要求拔卡', '刷卡', '付款失敗', '還是不能用', '不能用'],
      '聯絡方式(연락처)': ['電話', '電話號碼', '聯絡', '聯繫方式', 'email', 'LINE', '信箱', '寄件人', '收件人', '地址'],
      '網站(웹사이트)': ['網站', '網頁', '官網']
    };
    var synonymMap = {};
