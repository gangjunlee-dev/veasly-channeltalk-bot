...
var CATEGORIES = {
  ...
  product: {
    name: '商品諮詢',
    nameKo: '상품 문의',
    keywords: ['商品', '產品', '尺寸', '顏色', '款式', '版本', '真假', '正品', '全新', '二手', '小卡', '專輯', '價錢', '價格', '多少', '幾錢', '賣家', '有貨', '有沒有', '可以買', '怎麼買', '想買', '想問', '請問']
  },
  greeting: {
    name: '問候/感謝',
    nameKo: '인사/감사',
    keywords: ['謝謝', '感謝', '好的', '收到', 'ok', 'OK', '了解', '沒關係', '沒事', '不用了', '掰掰', '再見', '謝謝您', '感恩', '감사', '고마워', '알겠습', 'ㅋㅋ']
  },
  sticker: {
    name: '貼圖/表情',
    nameKo: '스티커/이모지',
    keywords: ['스티커를 전송했습니다', '스티커를 보냈습니다', '사진을 전송했습니다', '파일을 전송했습니다']
  },
  address: {
    name: '地址/收件',
    nameKo: '주소/수령',
    keywords: ['地址', '收件', '門市', '超商', '全家', '7-11', '統一', '香港', '住址', '修改地址', '改地址', '寄到哪']
  },
  business: {
    name: '營業時間',
    nameKo: '영업시간',
    keywords: ['上班', '營業', '幾點', '工作時間', '客服時間', '休息', '假日', '週末']
  },
  refund: {
    name: '退款/入帳',
    nameKo: '환불/입금',
    keywords: ['收到款', '入帳', '退款到', '沒收到錢', '匯款', '退回', '帳戶', '明細', '退款進度']
  },
    escalation: {
    name: '客服轉接',
    nameKo: '상담사 연결',
