...
var CATEGORIES = {
  ...
  order_status: {
    name: '訂單查詢',
    nameKo: '주문 상태/조회',
    keywords: ['訂單', '주문', '進度', '狀態', '多久', '等了', '天了', '幾天', 'update', '一個禮拜', '到了嗎', '還沒到', '沒收到', '收到了', '哪裡了', '查詢', '查', '筆'],
    regex: /\d{10,}/,
    priority: 2
  },
  shipping: {
    name: '配送相關',
    nameKo: '배송/물류',
    keywords: ['배송', '物流', '配送', '出貨', '發貨', '寄出', '到貨', '快遞', '順豐', '택배', '도착', '집운', '集運', '寄', '合併', '併單', '합배송', '香港', '寄到', '貨運', '包裹'],
    priority: 3
  },
  shipping_fee: {
    name: '國際運費',
    nameKo: '국제배송비/운임',
    keywords: ['國際運費', '운비', '배송비', '運費', '관세', '稅', '報關', '海關', '관부가세', '退嗎', '會再退'],
    priority: 4
  },
  cancel_refund: {
    name: '取消/退款',
  ...
  product: {
    name: '商品諮詢',
    nameKo: '상품문의/불량/교환',
    keywords: ['商品', '상품', '壞', '不能用', '損', '瑕疵', '品質', '색상', '色差', '換貨', '교환', '包包', '사이즈', '찾', '找', '有賣', '還有', '有沒有', '有嗎', '庫存', '재고', '구매', '開箱', '拍照', '影片', '品', '電子', '產品', '買嗎', '缺貨', '補貨', '上架', '連結', '購買', '拆解', '配件', '公克', '公斤', '販售', '化妝', '牽繩', '開團', '星巴克', '限定', '賣家'],
    priority: 7
  },
  account: {
    name: '帳號問題',
  ...
  howto: {
    name: '使用方式',
    nameKo: '사이트이용/주문방법',
    keywords: ['下訂', '無法', '怎麼', '如何', '방법', '使用', '操作', '어떻게', '下單', '線上', '可以嗎', '교환', '辦法', '代購', '重試', '跳出', '給我'],
    priority: 9
  },
  agent_request: {
    name: '轉接客服',
  ...
  complaint: {
    name: '客訴/不滿',
    nameKo: '클레임/불만',
    keywords: ['投訴', '差評', '很爛', '太慢', '太久', '拖了', '별로', '왜', '為什麼', '不滿', '失望', '多收', '被騙', '誇張', '離譜', '生氣', '처리', '問題', '沒有提到', '不知道', '完全沒有', '回覆', '不智能', '傻眼', '混亂'],
    priority: 10.5
  },
  greeting: {
    name: '問候/感謝',
