        ...
        for (var m = 0; m < messages.length; m++) {
          ...
          if (msg.personType === 'user') {
            ...
            if (text) {
              ...
              // 불용어 필터
              var stopwords = ['的','了','我','是','有','不','嗎','也','會','要','都','在','這','那','就','跟','很','吧','喔','呢','啊','但','還','可以','沒有','已經','因為','所以','如果','或者','然後','什麼','他們','我們','這個','那個','一下','一個','好的','沒關係','知道','對方','其他','以上','一直','比較','目前','之前','後來','然後','不是','為什麼','VEASLY','veasly','Veasly','team','mail','channel','iPhone','傳送','寫道'];
