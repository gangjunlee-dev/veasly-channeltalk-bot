...
var CATEGORIES = {
  ...
  product: {
    name: '商品諮詢',
    nameKo: '상품문의/불량/교환',
    keywords: ['商品', '상품', '壞', '不能用', '損', '瑕疵', '品質', '색상', '色差', '換貨', '교환', '包包', '사이즈', '찾', '找', '有賣', '還有', '有沒有', '有嗎', '庫存', '재고', '구매', '開箱', '拍照', '影片', '品', '電子', '產品'],
    priority: 7
  },
  account: {
    name: '帳號問題',
  ...
  howto: {
    name: '使用方式',
    nameKo: '사이트이용/주문방법',
    keywords: ['下訂', '無法', '怎麼', '如何', '방법', '使用', '操作', '어떻게', '下單', '線上', '可以嗎', '교환', '辦法', '代購', '可以嗎'],
    priority: 9
  },
  agent_request: {
    name: '轉接客服',
  ...
  complaint: {
    name: '客訴/不滿',
    nameKo: '클레임/불만',
    keywords: ['投訴', '差評', '很爛', '太慢', '太久', '拖了', '별로', '왜', '為什麼', '不滿', '失望', '多收', '被騙', '誇張', '離譜', '生氣', '처리', '問題', '沒有提到', '不知道', '完全沒有', '回覆'],
    priority: 10.5
  },
  greeting: {
    name: '問候/感謝',
...
function classifyMessage(text) {
  ...
  var shortConfirms = ['好','好的','嗯','嗯嗯','對','是','是的','知道了','了解','收到','好喔','好哦','好吧','ok','OK','okok','Ok','謝了','感謝','辛苦了','沒問題','可以','好噢','對啊','明白'];
