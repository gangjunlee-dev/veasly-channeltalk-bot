...
var CATEGORIES = {
  ...
  complaint: {
    name: '客訴/不滿',
    nameKo: '클레임/불만',
    keywords: ['投訴', '差評', '很爛', '太慢', '太久', '拖了', '別로', '왜', '為什麼', '不滿', '失望', '多收', '被騙', '誇張', '離譜', '生氣', '처리', '問題'],
    priority: 10.5
  },
  greeting: {
    name: '問候/感謝',
    nameKo: '인사/감사',
    keywords: ['你好', '妳好', '您好', '안녕', 'hello', 'hi', '嗨', '哈囉', '감사', '谢谢', '謝謝', '감사합니다', '고마워', '感謝', '在嗎', '請問', '不好意思', '了解', '好的', '知道了', '好喔', '好哦', '好吧', '嗯', '嗯嗯', '對', '是的', '收到'],
    priority: 11
  },
  points: {
    name: '點數/優惠',
