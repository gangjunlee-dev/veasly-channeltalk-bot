...
async function analyzeRecentChats(days) {
  ...
  try {
    ...
    for (var i = 0; i < allChats.length; i++) {
      ...
      var _hadRecentMsg = false; var _hadUserMsg = false; var _tmpTotal = 0; var _tmpUser = 0; var _tmpBot = 0; var _tmpMgr = 0;
