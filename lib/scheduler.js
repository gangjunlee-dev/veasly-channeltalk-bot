...
function startScheduler() {
  ...
  // FAQ auto-update: every Wednesday 3AM KST
  cron.schedule('0 3 * * 3', function() {
  ...
  console.log('[Scheduler] Started - Weekly report: Mon 9AM KST, Unresolved check: every 4h, FAQ update: Wed 3AM KST, Shipping tracker: every 2h');
}
...
module.exports = { startScheduler: startScheduler, checkUnresolvedChats: checkUnresolvedChats, sendWeeklyReport: sendWeeklyReport, parseCSATResponse: parseCSATResponse, isCSATPending: isCSATPending };
