...
var ITEMS = [
  ...
  },
  {
    ...
    text: '國際運費計算：以實際重量與材積重量（長×寬×高 cm ÷ 5000）中較大者為準。免運：訂單金額達 TWD 4,999 以上→ 5kg、9,999 以上→ 10kg、14,999 以上→ 15kg、19,999 以上→ 20kg、24,999 以上→ 25kg。超過免運額度的部分依超額重量表（從 0 開始）計算收費。不提供秤重照片，僅提供包裝箱尺寸供客戶確認。'
  },
  {
